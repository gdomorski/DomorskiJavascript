...
function ThirdGreatest(strArr){
    strArr.sort(function(a,b){return b.length-a.length});  //sorts the function from the largest in length to shortest
    return strArr[2]; //takes the third value from the array
}